...
public class taxTableForLoop {
	public static void main(String[] args) {
		...
		System.out.println("enter the first annual salary: ");
		...
		for (annualSalary = startingAnnualSalary; annualSalary < endingAnnualSalary; annualSalary += 500) {
